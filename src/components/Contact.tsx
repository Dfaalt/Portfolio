...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-20 relative overflow-hidden gradient-bg">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto px-4">
            Have an interesting project? Don't hesitate to get in touch.
          </p>
        </motion.div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-5 sm:p-8 glow-effect">
